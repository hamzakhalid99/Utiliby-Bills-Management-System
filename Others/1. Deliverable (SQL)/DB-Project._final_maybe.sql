...
--
-- Host: localhost:3306
-- Generation Time: Dec 13, 2020 at 08:25 AM
...
(29, 'Residential', 0, -310, b'0'),
(31, 'Residential', 0, -310, b'0'),
...
INSERT INTO `invoice` (`invoice_id`, `user_id`, `utility_id`, `bill_amount`, `amount_received`, `bill_due`, `bill_status`, `bill_generation_date`, `date_of_payment`) VALUES
(68, 29, 'EC', 310, 0, 310, b'1', '2020-12-13', NULL),
(69, 31, 'EC', 310, 0, 310, b'1', '2021-01-15', NULL);
...
CREATE TABLE `Messages` (
  ...
  `message_content` text CHARACTER SET utf8mb4,
...
INSERT INTO `Registers_For` (`utility_id`, `user_id`, `connection_type`, `units_consumed`, `utility_balance`, `due_date`, `days_overdue`, `status`) VALUES
('EC', 29, 'Commercial', 0, -310, '2021-01-13', 2, b'1'),
('EC', 31, 'Commercial', 0, -310, '2021-02-15', 0, b'1');
...
--
ALTER TABLE `complaint`
  MODIFY `complaint_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
...
--
ALTER TABLE `invoice`
  MODIFY `invoice_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
--
...
--
ALTER TABLE `Messages`
  ADD CONSTRAINT `Messages_ibfk_1` FOREIGN KEY (`complaint_id`) REFERENCES `complaint` (`complaint_id`) ON DELETE CASCADE;
