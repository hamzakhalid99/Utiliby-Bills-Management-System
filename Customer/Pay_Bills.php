  ...
  <body>
    ...
    <div class="wrapper d-flex align-items-stretch">
      ...
      <div id="content" class="p-4 p-md-5">
        ...
        <tbody>
          <?php
            ...
            $query = "SELECT * FROM invoice 
                      WHERE invoice.user_id='".$user_id."' AND invoice.utility_id='".$utility_id."' AND invoice.bill_status= 1;";
        ...
        <hr style="border-width: 2px;">
        <br>
        <form method="post" action=<?php echo "'payment.php?utility_id=".$utility_id."'"; ?> >
          <div class="form-row">
            <div class="form-group col">
              <label style="font-size: 20px;">Enter Invoice ID</label>
              <input type="number" name="invoice_id" class="form-control form-control-lg"  placeholder="ID">
            </div>
            <div class="form-group col">
              <label style="font-size: 20px;">Enter Amount</label>
              <input type="number"  name="amount" class="form-control form-control-lg"  placeholder="0.0">
            </div>
          </div>
