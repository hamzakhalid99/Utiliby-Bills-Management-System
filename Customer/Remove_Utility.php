  ...
  <body>
    ...
    ?>
      ...
      <div id="content" class="p-4 p-md-5">
        ...
        <div class="container-fluid">
          <div class="row">
            <h2 style="font-size: 50px">REMOVE UTILITY</h2>
        ...
        <div class="container" style="padding-top: 50px">
          <div class='row justify-content-center'>
            <?php 
              ...
              $query = "SELECT Utilities.utility_name, Utilities.image, Registers_For.utility_id, Registers_For.utility_balance
              ...
              else
              {
                for ($i = 0;$i < $count;$i++)
                {
                  ...
                  $balance = $tuples["utility_balance"];

                   echo "<a href='Remove.php?id=".$id."&balance=".$balance."'><div class='col-sm-5 custom-column-spacing'><div class='container bg-dark custom-image-circle' style=' background-image: url(pics/" . $path . ");'></div></div></a>";
